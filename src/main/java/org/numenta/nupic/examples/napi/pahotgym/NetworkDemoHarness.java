...
public class NetworkDemoHarness {
    ...
    public static Parameters getNetworkDemoTestEncoderParams() {
        ...
        p.setParameterByKey(KEY.CELLS_PER_COLUMN, 16);
        ...
        p.setParameterByKey(KEY.SYN_PERM_CONNECTED,0.21);
        ...
        p.setParameterByKey(KEY.PERMANENCE_INCREMENT, 0.07);
    ...
    public static Parameters getParameters() {
        ...
        parameters.setParameterByKey(KEY.CONNECTED_PERMANENCE, 0.21);
